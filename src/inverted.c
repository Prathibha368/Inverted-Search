            ...
            if(strcmp(ptr,".txt")==0){
                ...
                if(fptr!=NULL){
                    ...
                    if(size!=0){
                        ...
                        printf(YELLOW"INFO : Successful: inserting file name %s into file linked list \n"RESET,argv[i]);
                        }
                        else{
                ...
                printf(RED"INFO :%s =>This file has no extension file\n"RESET,argv[i]);
            }
        }
        else{
            printf(RED"INFO : %s =>This file has not a .txt file\n"GREEN,argv[i]);
        }
        i++;
    }
    printf("\n");
